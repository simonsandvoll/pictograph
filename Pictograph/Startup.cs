...
namespace Pictograph
{
    ...
    {
        private string KeyVaultUrl = "https://keyvault160821.vault.azure.net/";
        private string SecretIdentifier = "keyVault160821-secret-storageacc160821";
        ...
        public string GetStorageConnectionString()
        {
            ...
            KeyVaultSecret secret = client.GetSecret(SecretIdentifier);
